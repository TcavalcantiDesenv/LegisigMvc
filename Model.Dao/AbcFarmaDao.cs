...
namespace Model.Dao
{
    public class AbcFarmaDao : Obrigatorio<ProdutosAbcFarma> 
    {
        ...
        public bool find(ProdutosAbcFarma obj)
        {
            bool temRegistros;
            string find = "select * from AbcFarma where ID_PRODUTO='" + obj.ID_PRODUTO + "'";
            try
            {
        ...
        public bool buscarProdutoPorEan(ProdutosAbcFarma obj)
        {
            bool temRegistros;
            string find = "select * from AbcFarma where EAN='" + obj.EAN + "'";
            try
            {
                comando = new SqlCommand(find, objConexaoDB.getCon());
                objConexaoDB.getCon().Open();
        ...
        {
            List<ProdutosAbcFarma> listaClientes = new List<ProdutosAbcFarma>();
            string find = "select * from AbcFarma order by Nome asc";
            try
            {
                comando = new SqlCommand(find, objConexaoDB.getCon());
                objConexaoDB.getCon().Open();
                ...
                while (reader.Read())
                {
                    ProdutosAbcFarma obj = new ProdutosAbcFarma();
                    obj.ID_PRODUTO = reader["ID_PRODUTO"].ToString();
                    obj.EAN = reader["EAN"].ToString();
                    obj.REGISTRO_ANVISA = reader["REGISTRO_ANVISA"].ToString();
                    obj.GGREM = reader["GGREM"].ToString();
            ...
            {
                ProdutosAbcFarma obj2 = new ProdutosAbcFarma();
                obj2.Estados = 1000;
            }
            finally
            {
        ...
        public void update(ProdutosAbcFarma obj)
        {
            throw new System.NotImplementedException();
        }
        public void create(ProdutosAbcFarma obj)
        {
            string create = @"insert AbcFarma(ID_PRODUTO,EAN,REGISTRO_ANVISA,GGREM,NOME,DESCRICAO,COMPOSICAO,QTD_EMBALAGEM,PF_20,PMC_20,
        ...
        public void delete(ProdutosAbcFarma obj)
        {
            string delete = "delete from AbcFarma where EAN ='" + obj.EAN + "'";
            try
            {
        ...
        {
            string delete = "delete from AbcFarma ";
            try
            {
                comando = new SqlCommand(delete, objConexaoDB.getCon());
                objConexaoDB.getCon().Open();
