<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeisParametros.aspx.cs" Inherits="PlatinDashboard.Presentation.MVC.Paginas.LeisParametros" %>
...
<form id="form1" runat="server">
                ...
                <DetailRow>
                    <dx:ASPxGridView ID="GridParametros" runat="server" Width="100%" AutoGenerateColumns="False" DataSourceID="SqlParametros" OnBeforePerformDataSelect="GridParametrosClientes_BeforePerformDataSelect" KeyFieldName="Id" Theme="Office2010Silver">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="Item" Caption="Capitulo da Lei" VisibleIndex="3">
                                <Settings AllowEllipsisInText="True" />
                            </dx:GridViewDataTextColumn>
	...
	loadingPanel.Hide();
        ...
        <asp:SqlDataSource ID="SqlLegisGeral" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnection %>"
        ...
        <asp:SqlDataSource ID="SqlParametros" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnection %>"
        ...
        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:PortalConnection %>'
            DeleteCommand="DELETE FROM [Sistemas] WHERE [Id] = @Id"
            InsertCommand="INSERT INTO [Sistemas] ([Sistema]) VALUES (@Sistema)"
            SelectCommand="SELECT * FROM [Sistemas]"
            UpdateCommand="UPDATE [Sistemas] SET [Sistema] = @Sistema WHERE [Id] = @Id">
