...
function initGetData() {
    ...
    $('#btnGetData').click(function () {
        ...
        request.open('GET', '../LeisParametros/BuscarDados', true);
        request.onload = function () {
            if (request.status === 200) {
                ...
                while (i <= myStuff.length - 1) {
                    ...
                    grid1.append('<tr><td><div class=expanded id=' + i + '></div></td><td>' + obj.Sistema + '</td><td>' + obj.Ambito + '</td><td>' + obj.Tema + '</td></tr>' + addresslist);
                    i++;
                }
