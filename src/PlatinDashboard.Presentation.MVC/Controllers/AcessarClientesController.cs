...
namespace PlatinDashboard.Presentation.MVC.Controllers
{
    public class AcessarClientesController : BaseController
    {
        ...
        private bool AlterarVinculoUsuarioCompania(int CompanyId, string CompanyName)
        {
            ...
            var usuarioViewModel = ((List<UserViewModel>)_userAppService.GetByCompany(CompanyId)).Find(p => CompanyName.Contains(CompanyName));
            ...
            Session["AlteraCliente"] = usuarioViewModel.CompanyId;
