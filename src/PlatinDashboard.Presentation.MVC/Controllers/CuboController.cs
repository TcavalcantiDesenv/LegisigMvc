...
namespace PlatinDashboard.Presentation.MVC.Controllers
{
    ...
    public class CuboController : BaseController
    {
        ...
        [HttpPost]
        [ClaimsAuthorize("ChartCubo", "Allowed")]
        public ActionResult Index([Bind]PivotGridChartIntegrationDemoOptions options)
        {
        ...
        public ActionResult DynamicChart()
        {
            ...
            var chartModel = PivotGridExtension.GetDataObject(PivotGridCuboHelper.PivotChartIntegrationSettings(), model);
            return PartialView("_DynamicChart", chartModel);
        }
    }
}